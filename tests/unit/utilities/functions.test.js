...
describe('Utility functions', function () {
  ...
  describe('producing random strings', function () {
    it('returns 10 character length randomized string', function () {
      expect(functions.randomString(10))
        .toMatch(/^[A-Za-z0-9]{10}$/)
    })
    it('returns 3 character length randomized string', function () {
